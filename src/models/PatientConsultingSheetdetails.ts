...
import { PicasoAdviceList } from './AdviceList';
import { Sequelize } from 'sequelize-typescript';

@Table({
  tableName: 'picaso_patientconsultingsheetdetails',
  timestamps: false,
})
export class PicasoPatientConsultingSheetDetails extends Model {
  @Column({
    field: 'ID',
  ...
  @HasMany(() => PicasoAdviceList, {
    foreignKey: 'PrescriptionID',
    sourceKey: 'ID',
  })
  adviceList?: PicasoAdviceList[];
