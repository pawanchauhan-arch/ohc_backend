    ...
    const encrypted = crypto.publicEncrypt(
      {
        ...
        oaepHash: 'sha1', // Matches your cipher type "RSA/ECB/OAEPWithSHA-1AndMGF1Padding"
      },
      buffer,
    );
